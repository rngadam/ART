...
public class SettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editTextServerIp.setText(preferences.getString(
				ClientConstants.SERVER_IP_PREF, ClientConstants.DEFAULT_IP));
		editTextServerPort.setText(""
				+ preferences.getInt(ClientConstants.SERVER_PORT_PREF,
	...
	protected void onStop() {
		...
		editor.putString(ClientConstants.SERVER_IP_PREF, editTextServerIp
				.getText().toString());
		editor.putInt(ClientConstants.SERVER_PORT_PREF,
				Integer.valueOf(editTextServerPort.getText().toString()));
