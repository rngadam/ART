...
int sensor_readings[] = new int[NUMBER_READINGS];
...
void draw() {
  ...
  int start = height/2;
  text(sensor_readings[SENSOR_LEFT], 100, start);
  text(sensor_readings[SENSOR_FRONT], 300, start);
  text(sensor_readings[SENSOR_RIGHT], 500, start);

  text(sensor_readings[SENSOR_LEFT_SIDE], 50, start + 50);
  text(sensor_readings[SENSOR_RIGHT_SIDE], 550, start + 50);

  text(sensor_readings[SENSOR_BACK_LEFT], 100, start + 100);
  text(sensor_readings[SENSOR_BACK], 300, start + 100);
  text(sensor_readings[SENSOR_BACK_RIGHT], 500, start + 100);
}
